set GOOS=darwin&& set GOARCH=arm64&& go build -o bin\ZohoExpense2Payday_mac-arm .
set GOOS=darwin&& set GOARCH=amd64&& go build -o bin\ZohoExpense2Payday_mac-intel .
set GOOS=linux&& set GOARCH=arm64&& go build -o bin\ZohoExpense2Payday_linux-arm .
